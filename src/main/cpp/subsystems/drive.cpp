...
void subsystems::drive::Drivetrain::update_nt() {
    ...
    frc::SmartDashboard::PutNumber("Drivetrain_speed_goal", units::feet_per_second_t{front_left.get_goal().speed}.value());
    frc::SmartDashboard::PutNumber("Drivetrain_serveAngle_goal", front_left.get_goal().angle.Degrees().value());
